...
const appSetting = {
  databaseURL: "https://sysufe01-default-rtdb.firebaseio.com/"
}
  ...
  function handleSubmit(e){
    ...
    if(subject && describe && selectedCategory){
      ...
      if(selectedCategory){
        ...
        // Show toast notification for successful story post
  ...
  return (
    <div className='flex'>
      ...
      <div className='story-section'>
        <ToastContainer position="top-right" autoClose={2000} /> {/* toast Notification */}
   ...
   { /* BUG 2 , changed the position of the existing code */ }
      ...
      {/* If no stories are found */}
            {mappable.length === 0 && <div>No stories found</div>} 
          </div>
          : 
          (<div className='container'>
            <section className='item-section-main'>
